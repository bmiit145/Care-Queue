 ...
 */
router.route('/')
    .post(auth_middleware_1.protect, (0, auth_middleware_1.authorize)('PLATFORM_ADMIN'), organization_controller_1.createOrganization)
    .get(auth_middleware_1.protect, (0, auth_middleware_1.authorize)('PLATFORM_ADMIN'), organization_controller_1.getOrganizations);

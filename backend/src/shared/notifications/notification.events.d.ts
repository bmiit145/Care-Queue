 ...
 */
export type NotificationEventType = 'APPOINTMENT_BOOKED' | 'APPOINTMENT_CONFIRMED' | 'APPOINTMENT_CANCELLED' | 'APPOINTMENT_REMINDER' | 'APPOINTMENT_RESCHEDULED' | 'CHECKIN_COMPLETED' | 'QUEUE_JOINED' | 'QUEUE_POSITION_CHANGED' | 'PATIENT_CALLED' | 'PATIENT_RECALLED' | 'PATIENT_SKIPPED' | 'PATIENT_NO_SHOW' | 'DOCTOR_DELAYED' | 'VISIT_STARTED' | 'VISIT_COMPLETED';
